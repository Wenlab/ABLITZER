...
*    DigPulseTrain-Cont-PauseTrig.c
*
* Example Category:
*    CO
*
...
{
	// Simultaneously hardware trigger two cameras
	int         error = 0;
	...
	DAQmxErrChk(DAQmxCreateCOPulseChanFreq(taskHandle, "Dev1/ctr0", "", DAQmx_Val_Hz, DAQmx_Val_Low, 0.0, 100.0, 0.5));
