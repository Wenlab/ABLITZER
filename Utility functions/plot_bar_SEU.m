...
y1_std=[std(output_OLcontrol.PITime_Baseline,1)/sqrt(length(output_OLcontrol.PITime_Baseline)),std(output_OLcontrol.PITime_Test,1)/sqrt(length(output_OLcontrol.PITime_Test)),...
      ...
      std(output_Unpaired.PITime_Baseline,1)/sqrt(length(output_Unpaired.PITime_Baseline)),std(output_Unpaired.PITime_Test,1)/aqrt(length(output_Unpaired.PITime_Test))];
...
y2_std=[std(output_OLcontrol.PITurn_Baseline,1)/sqrt(length(output_OLcontrol.PITurn_Baseline),std(output_OLcontrol.PITurn_Test,1)/sqrt(length(output_Olcontrol.PITurn_Test),...
      std(output_OLexp.PITurn_Baseline,1)/sqrt(length(output_exp.PITurn_Baseline),std(output_OLexp.PITurn_Test,1)/sqrt(length(output_exp.PITurn_Test),...
      std(output_Unpaired.PITurn_Baseline,1)/sqrt(length(output_Unpaired.PITurn_Baseline)),std(output_Unpaired.PITurn_Test,1)/sqrt(length(output_Unpaired.PITurn_Test)];
